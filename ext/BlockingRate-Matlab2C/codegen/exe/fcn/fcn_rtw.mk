...
## 
## Makefile     : fcn_rtw.mk
## Generated on : Fri Jun 02 14:18:46 2017
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/fcn.exe
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/fcn.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/exe/fcn -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=fcn -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)/codegen/exe/fcn/fcn_initialize.cpp $(START_DIR)/codegen/exe/fcn/fcn_terminate.cpp $(START_DIR)/codegen/exe/fcn/fcn.cpp $(START_DIR)/codegen/exe/fcn/rt_nonfinite.cpp $(START_DIR)/codegen/exe/fcn/rtGetNaN.cpp $(START_DIR)/codegen/exe/fcn/rtGetInf.cpp
...
OBJS = fcn_initialize.obj fcn_terminate.obj fcn.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj
...
%.obj : $(START_DIR)/codegen/exe/fcn/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/codegen/exe/fcn/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
