...
systemParameters.modulationFormat = modulationFormat; %'PM_QPSK';
...
%####################################################################
Ndemands = 5550; % don't need to change
...
Sbins = 15;
% RoutingScheme = 'MD';
% alg = 'benchmark_Bathula_MD_subopt'; % or 'proposed1', 'proposed2'
% nRS = 20;
...
%% Monte Carlo
x = load('templateDemandStructMDForC.mat');
DemandStructTemplate = x.DemandStructMD;
% clear x;
