...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/fcn.lib
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/fcn.lib
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/fcn -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
SRCS = $(START_DIR)/codegen/lib/fcn/fcn_initialize.cpp $(START_DIR)/codegen/lib/fcn/fcn_terminate.cpp $(START_DIR)/codegen/lib/fcn/fcn.cpp $(START_DIR)/codegen/lib/fcn/rt_nonfinite.cpp $(START_DIR)/codegen/lib/fcn/rtGetNaN.cpp $(START_DIR)/codegen/lib/fcn/rtGetInf.cpp
...
%.obj : $(START_DIR)/codegen/lib/fcn/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/codegen/lib/fcn/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
