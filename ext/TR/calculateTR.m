...
nChannels = floor(4000/(bitRate/spectralEfficiency));
Nreach = findReach(bitRate, spectralEfficiency, nChannels, 15, systemParameters);
fprintf('TR of %d Gbps channel in PM-QPSK is %d km\n', bitRate, Nreach*L*1e-3);