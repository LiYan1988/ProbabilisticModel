...
Sbins = 15;
RoutingScheme = 'MD';
alg = 'benchmark'; % or 'proposed1', 'proposed2'
nRS = 20;
%####################################################################
...
% proposed algorithm
if strcmp(alg, 'proposed1')
    x = load('RSMD1.mat');
    RS = x.Ii_sort_idx;
    TopologyStruct.RegenSites = RS(1:nRS);
elseif strcmp(alg, 'proposed2')
    x = load('RSMD2.mat');
    RS = x.Cn_sort_idx;
    TopologyStruct.RegenSites = RS(1:nRS);
elseif strcmp(alg, 'benchmark')
    x = load('ResultsBH20.mat');
    RS = x.RS2;
    TopologyStruct.RegenSites = RS;
elseif strcmp(alg, 'benchmark2')
