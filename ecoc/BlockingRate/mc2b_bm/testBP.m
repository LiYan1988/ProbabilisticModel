...
systemParameters.gb = 20; % the guardband
...
x = load('RSMD1.mat');
RS = x.Ii_sort_idx;
TopologyStruct.RegenSites = RS(1:20);
% benchmark
% x = load('ResultsBH20.mat');
% RS = x.RS2;
% TopologyStruct.RegenSites = RS(1:20);

% DemandStructTemplate.distributionParameter1 = 60;
% DemandStructTemplate.distributionParameter2 = 10;
...
[blockStatistics2, blockHistory2, runtime2] = ...
    simulateBlockProb(systemParameters, TopologyStruct, ...
    SimulationParameters, DemandStructTemplate);