...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr  9 15:19:38 2017
...
# input file names
python_file_template = simulation_name+'_{}_{}.py'
slurm_file_template = simulation_name+'_{}_{}.slurm'
...
#             54, 55, 56, 57]
array_id = np.arange(1, 101, 1)

for batch_id in array_id:
    for mat_id in range(1, 51):
        # write python files
        python_src = "template_python.py"
        line13 = "kwargs = {}\n".format(kwargs.__repr__())
        line15 = "array_id = {}\n".format(batch_id)
        line16 = "mat_id = {}\n".format(mat_id)
        replace_lines = {15:line15, 13:line13, 16:line16}
        python_dst = python_file_template.format(batch_id, mat_id)
        ...
        slurm_dst = slurm_file_template.format(batch_id, mat_id)
