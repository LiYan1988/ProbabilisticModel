...
filename = sprintf('figures/simuCompareUpperBoundNetwork-DT-%ddemands-uniform.fig', Ndemands);
savefig(filename)
filename = sprintf('figures/simuCompareUpperBoundNetwork-DT-%ddemands-uniform.png', Ndemands);
